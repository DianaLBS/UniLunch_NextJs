    ...
    <div className="flex h-screen items-center justify-center bg-cover bg-center m-0 p-0" style={{ backgroundImage: `url(${backgroundImage.src})` }}>
      <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row max-w-4xl w-full overflow-hidden">
        <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-700 p-4">
          <h1 className="text-4xl font-bold text-white">¡Bienvenido a UniLunch</h1>
        ...
        <div className="flex flex-col items-center justify-center p-8 md:w-1/2 w-full">
          <Image src={uniLunchLogo} alt="Logo UniLunch" width={200} height={200} />
